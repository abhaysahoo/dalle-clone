...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.name && form.prompt && form.photo) {
      ...
      try {
        const response = await fetch('https://dalle-clone-zsn9.onrender.com/api/v1/post', {
          method: 'POST',
          headers: {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://dalle-clone-zsn9.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
            "Content-Type": "application/json"
          },
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-5 flex gap-5'>
          <button
            ...
            className='text-white bg-green-700 font-md 
        ...
        <div className='mt-10'>
          ...
          <button
            ...
            rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center capitalize'
          >
